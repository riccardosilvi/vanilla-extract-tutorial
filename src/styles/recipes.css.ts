...
// default-invert are the value of StatsContext for variant names
export const stats = recipe({
  base: sprinkles({
    ...
    // sprinkles let us handle responsively specifies props
  ...
  variants: {
    color: {
      ...
      // also from sprinkles condition based values ( theming )
